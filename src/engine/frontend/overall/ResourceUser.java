...
public abstract class ResourceUser {
	 ...
	 * @param s - string used to find default bundle location for resource bundle
	 */
	 ...
	 * @param input - String - given resource input key
	 ...
	 * @param input - String - given resource input key
	 * @param regex - String used to split key value into array of Strings
	 * @return - returns 
	 */

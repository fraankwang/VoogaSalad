...
public abstract class AbstractPane extends ResourceUser {
	 ...
	 * 
	 * @param ev
	 *            - requires an engine view to set as
	 * @param s
	 *            - string to instantiate a resource user
	 */
	 ...
	 * 
	 * @param widthBinding
	 *            - DoubleExpression binding this region to another region's
	 *            widthProperty
	 * @param heightBinding
	 *            - DoubleExpression binding this region to another region's
	 *            heightProperty

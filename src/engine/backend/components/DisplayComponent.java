...
public class DisplayComponent extends Component {
	...
	/**
	 * 
	 * @return True if the entity with this component can be shown. False if the
	 *         entity of the component can not be shown.
	 */
	...
	/**
	 * Takes a string, turns it into a boolean and sets whether the image can be
	 * shown based on the boolean.
	 * 
	 * @param bool
	 */

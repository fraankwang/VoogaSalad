...
// if
// (iEntity.hasComponent(getComponentTagResources().getString(COMPONENT_TAG))) {
// checkInput(iEntity);
// }
// }
// }
...
// UserInputComponent toChange =
// (UserInputComponent)iEntity.getComponent(getComponentTagResources().getString(COMPONENT_TAG));

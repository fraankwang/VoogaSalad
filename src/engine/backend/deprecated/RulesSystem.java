...
//
// @Override
// public void update(Level myLevel, InGameEntityFactory myEntityFactory,
...
// String componentToChange =
/// eachRule.getMyConditionals().get(0).whichComponentToCheck();
...
// try {
// Method method = eachRule.getClass().getMethod(methodToInvoke, new Class[]
/// {IComponent.class, Integer.class});
// try {
// method.invoke(eachRule, component, delta);
// //above refleciton call represents this eachRule.increaseSize(component,
/// delta);

...
/**
 * Main Controller class for the HUD package. Contains a HUDModel, an
 * implementation of an AbstractHUDSCreen, and a dataSource
 * 
 * @author bobby
 *
 */
...
public class HUDController implements Observer {
	 ...
	 * 
	 * @param filename
	 *            - file where you saved your preferences from authoring
	 *            environment
	 * @param dataSource
	 *            - object that holds all of your relevant game data, or
	 *            references to other classes that contain it
	 * @param valueFinder
	 *            - you need to write a custom ValueFinder class for your own
	 *            project
	 */
	...
	/**
	 * Very simple file reader that returns the fields to follow based on the
	...
	private List<String> getFieldsToFollow() {
		return Arrays.asList("lives", "resources", "mode", "level");
	}
	...
	/**
	 * Handles the change whenever any object (most likely Property) that this
	 * is observing has changed. It does so by telling both the model and view

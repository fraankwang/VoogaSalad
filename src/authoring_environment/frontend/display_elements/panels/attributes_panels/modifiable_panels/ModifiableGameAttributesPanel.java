...
public class ModifiableGameAttributesPanel extends ModifiableAttributesPanel {
	...
	protected void assembleComponents() {
		...
		myAttributesGridPane.add(new Text("Number of Players"), 1, 0);
		myAttributesGridPane.add(new Label("Number of Starting Lives"), 0, 1);
		myAttributesGridPane.add(new Label("Number of Lives For Defeat"), 0, 2);
		myAttributesGridPane.add(new Label("Game Timer"), 0, 3);
		myAttributesGridPane.add(new Label("Starting Resources"), 0, 4);
	}

...
public class EntityComponents {
	...
	static {
		...
		aMap.put("DisplayComponent", Arrays.asList("DisplayComponent_CanBeShown",
												"DisplayComponent_Image"));
		aMap.put("FiringComponent", Arrays.asList("FiringComponent_Ammunition",
												"FiringComponent_AmmunitionSpeed",
												"FiringComponent_EnemyInSightRange",
												"FiringComponent_Targets",
												"FiringComponent_FiringRate"));
		aMap.put("SizeComponent", Arrays.asList("SizeComponent_Width",
												"SizeComponent_Height"));
		aMap.put("HealthComponent", Arrays.asList("HealthComponent_Health",

...
public class Constants {
	...
	private static final ResourceBundle myIntBundle = ResourceBundle
			.getBundle(DEFAULT_RESOURCE_PACKAGE + DEFAULT_RESOURCE_FILE_INTS);
	private static final ResourceBundle myStringBundle = ResourceBundle
			.getBundle(DEFAULT_RESOURCE_PACKAGE + DEFAULT_RESOURCE_FILE_STRINGS);
